...
OUTPUT_FILE = BASE_DIR.parent / "reports" / "summaries" / "animations.json"
...
def main():
    ...
    deep_file = OUTPUT_FILE.parent.parent / "details" / "animations_deep.json"
    deep_report = {
        "check": "animation_constants",
