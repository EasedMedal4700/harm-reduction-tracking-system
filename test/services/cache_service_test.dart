...
void main() {
  ...
  group('CacheService Expiration', () {
    ...
    test('should clear only expired entries', () async {
      cache.set('short_lived', 'value1', ttl: const Duration(milliseconds: 50));
      cache.set('long_lived', 'value2', ttl: const Duration(seconds: 10));
  ...
  group('CacheKeys Helpers', () {
    test('should generate correct cache keys', () {
      ...
      expect(
        CacheKeys.recentEntries('user-123-uuid'),
        equals('recent_entries:user:user-123-uuid'),
      );
      expect(
