...
void main() {
  ...
  group('DailyCheckinService', () {
    test('fetchCheckinsByDate returns checkins', () async {
      ...
      final fakeBuilder = FakePostgrestBuilder<List<Map<String, dynamic>>>(mockData);
      
      when(mockSupabaseClient.from('daily_checkins')).thenAnswer((_) => mockQueryBuilder);
...
class FakePostgrestBuilder<T> extends Fake implements PostgrestFilterBuilder<T>, PostgrestTransformBuilder<T> {
  ...
  @override
  PostgrestFilterBuilder<T> delete({bool count = false, String? returning}) => this;
  
  @override
  PostgrestFilterBuilder<T> update(Map<String, dynamic> values, {bool count = false, String? returning}) => this;
  
  @override
  PostgrestFilterBuilder<T> insert(dynamic values, {bool count = false, String? returning}) => this;
