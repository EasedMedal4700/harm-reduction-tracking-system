...
class BucketToleranceModel {
  ...
  factory BucketToleranceModel.fromJson(String substanceName, Map<String, dynamic> json) {
    final neuroBucketsJson = json['neuro_buckets'] as Map<String, dynamic>? ?? {};
    ...
    return BucketToleranceModel(
      ...
      toleranceDecayDays: (json['tolerance_decay_days'] as num?)?.toDouble() ?? 7.0,
